...
const Booking = () => {
  ...
  const fetchSalonData = async () => {
    try {
      const response = await fetch('http://192.168.0.28:8888/efrizer/php_api/get_salon_by_slug.php', {
        method: 'POST',
        headers: {
  ...
  const fetchAvailableSlots = async (date, serviceId) => {
    try {
      const response = await fetch('http://192.168.0.28:8888/efrizer/php_api/get_available_slots.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSubmit = async (e) => {
    ...
    if (step === 4) {
      ...
      try {
        const response = await fetch('http://192.168.0.28:8888/efrizer/php_api/create_appointment.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
